...
def fetch_and_process_data(time_hours):
    ...
    """
    data = fetch_power_breakdown_history(zone="IN-WE")
...
def render_pie_charts2():
    ...
    with col1:
        ...
        st.plotly_chart(fig_imp, use_container_width=True, key="fig_imp_chart")
    ...
    with col2:
        ...
        st.plotly_chart(fig_export, use_container_width=True, key="fig_export_chart")
